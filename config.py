...
WATCHDOG_TAG = "SOPT-WD-STATUS.DROP5/55.UNIT1@NET0"
SAFEGUARD_TAG = "BAT SOPT ALARM SAFEGUARD NOT PERMIT"
SAFEGUARD_SOPT_TAG = "SAFEGUARD:SOOTBLOW"
SAFEGUARD_USING_MAX_VIOLATED = True

DESC_ENABLE_COPT = "BAT SOPT ENABLE STATUS"
