...
ssh ichsan@10.7.1.116 -p 24016 'cp ~/CombustionOpt/zipped/services-combustion-pct1-v1.6.1.tar ~/CombustionOpt/zipped/services-combustion-pct1-v1.7.tar'
rsync -Pavre "ssh -p 24016" ../services-combustion-pct1-v1.7.tar ichsan@10.7.1.116:~/CombustionOpt/zipped/.
