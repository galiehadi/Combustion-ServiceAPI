...
# ssh surya@10.7.1.116 -p 24017 'cp ~/CombustionOpt/zipped/services-combustion-pct2-v1.5.4.tar ~/CombustionOpt/zipped/services-combustion-pct2-v1.5.5.tar'
rsync -Pavre "ssh -p 24017" ../services-combustion-pct2-v1.5.5.tar surya@10.7.1.116:~/CombustionOpt/zipped/.
